...
This is a modified rendering algorithm which accepts a variable amt of "pseudo-RGB" channels
"""
...
def variable_rendering(
    ...
    Args:
        ...
        num_channels: number of channels in the input tensor, Default RGB, 3
    ...
    if rgb_sigma_fn is not None:
        ...
        assert rgbs.shape[-1] == num_channels, "rgbs must have {} channels, got {}".format(num_channels,
            rgbs.shape
        )
        assert (
